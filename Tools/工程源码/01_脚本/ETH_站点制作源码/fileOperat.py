...
# # 域名注册界面跳转
# chrome.implicitly_wait(20)
# chrome.find_element(By.ID, 'dropdown-43575').click()
...
#         chrome.find_element(By.ID, 'dns-value').send_keys('104.168.157.22')
...
# 开始登录宝塔上传文件
chrome.execute_script("window.open('http://104.168.157.22:8888/5f22e1c1')")
chrome.implicitly_wait(20)
...
#         chrome.implicitly_wait(20)
#         time.sleep(1)
#         while not chrome.find_element(By.XPATH, "//button[contains(text(),'关闭SSL')]"):
#             chrome.implicitly_wait(20)
