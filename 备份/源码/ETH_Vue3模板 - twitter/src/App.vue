...
<!--              />-->
            ...
            <span class="right-content-top-l2">LIMITED CLAIM</span>
            <div class="right-content-top-l3">
              <span>{{ time }}</span>
              <span class="tag">PRE-CLAIM IS LIVE</span>
            </div>
          </div>
          <div class="right-content-bottom">
            <div class="right-content-bottom-l1" v-show="false">
              <div>
            ...
            <!-- @click="getAccount" v-if="showConnect" -->
            <div
              ref="connectBtn"
              class="right-content-bottom-l2 connect"
              style="display: block"
              id="btn1"
            >
              CONNECT
            ...
            <span class="right-content-bottom-l3">Claim In Progress</span>
          </div>
        </div>
      </div>
    </div>
